...
<body>
            ...
            <div class="content-layout">
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $mayashope_onrtime_record; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><a href=<?php echo e("mayashope_onrtime_record_view/".$data['id']); ?> style="color:black;">view</a></td>
                                <td><?php echo e($data['guardian']); ?></td>
                                <td><?php echo e($data['contact_details']); ?></td>
                                <td><?php echo e($data['child_name']); ?></td>
                                <td><?php echo e($data['no_of_surgery_done']); ?></td>
                                <td><?php echo e($data['date_of_surgery']); ?></td>
                                <td class="actions">
                                    <a href=<?php echo e("mayashope_onrtime_record_edit/".$data['id']); ?>><img src="/img/edit.png" alt="edit"></a>
                                    <a href=<?php echo e("mayashope_onrtime_record_delete/".$data['id']); ?>><img src="/img/delete.png" alt="delete"></a>
                                    <a href=<?php echo e("mayashope_onrtime_record_print/".$data['id']); ?>><img src="/img/print.png" alt="print"></a>
                                </td>
                            </tr>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const childNames = <?php echo json_encode($mayashope_onrtime_record->pluck('child_name'), 15, 512) ?>;
            const creationDates = <?php echo json_encode($mayashope_onrtime_record->pluck('date_created'), 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\fundation-main\resources\views/mayashope_onrtime_record.blade.php ENDPATH**/ ?>