...
<body>
    ...
    <script>
        ...
        var mayashopeOnetimeCount = <?php echo e($mayashopeOnetimeCount ?? '0'); ?>;
        var chaliceCount = <?php echo e($chaliceCount ?? '0'); ?>;
        var eventCount = <?php echo e($eventCount ?? '0'); ?>;

        // Data for the created_at and updated_at fields
        var createdDates = <?php echo json_encode($createdDates ?? [], 15, 512) ?>;
        var updatedDates = <?php echo json_encode($updatedDates ?? [], 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\fundation-main\resources\views/admin_dasboard.blade.php ENDPATH**/ ?>